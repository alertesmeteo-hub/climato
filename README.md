...
- **version v1 « light »** : seule la période la plus récente publiée par Météo-France est retenue (glissante sur ~2 ans). L'historique long (jusqu'aux années 1950 selon les stations) et la comparaison aux normales 1991-2020 ne sont pas encore inclus ;
...
Le workflow automatique est lancé une seule fois par jour à 07 h 15 UTC.
...
Installez le ZIP séparé `climato-meteofrance-france-v1.0.0.zip`, activez-le, puis utilisez :
